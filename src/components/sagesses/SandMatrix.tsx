      ...
      <AnimatePresence mode="wait">
        {revealed ? (
          ...
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="mb-8 h-[200px] flex items-center justify-center"
          >
            <p className="text-sm italic" style={{ color: "hsl(36, 25%, 50%)" }}>
              Touchez une case pour révéler votre tirage…
            </p>
          </motion.div>
        )}
      </AnimatePresence>
